...
{
    f32 cos_pitch = cos(camera->transform.rotation.y);
    f32 sin_pitch = sin(camera->transform.rotation.y);
    f32 cos_yaw = cos(camera->transform.rotation.x);
    f32 sin_yaw = sin(camera->transform.rotation.x);
