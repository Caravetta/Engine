...
typedef void (APIENTRY * PFNGLUNIFORM2FPROC) ( GLint location, const GLfloat value_0, const GLfloat value_1 );
typedef void (APIENTRY * PFNGLUNIFORM1IPROC) ( GLint location, const GLint value );
...
CORE_API PFNGLCOMPILESHADERPROC 			glCompileShader;
CORE_API PFNGLGETSHADERIVPROC 				glGetShaderiv;
CORE_API PFNGLGETSHADERINFOLOGPROC 			glGetShaderInfoLog;
CORE_API PFNGLCREATEPROGRAMPROC 			glCreateProgram;
CORE_API PFNGLATTACHSHADERPROC 				glAttachShader;
CORE_API PFNGLLINKPROGRAMPROC 				glLinkProgram;
CORE_API PFNGLGETPROGRAMIVPROC 				glGetProgramiv;
CORE_API PFNGLGETPROGRAMINFOLOGPROC 		glGetProgramInfoLog;
CORE_API PFNGLDELETESHADERPROC 				glDeleteShader;
CORE_API PFNGLDELETEPROGRAMPROC 			glDeleteProgram;
CORE_API PFNGLGENVERTEXARRAYSPROC 			glGenVertexArrays;
CORE_API PFNGLBINDVERTEXARRAYPROC 			glBindVertexArray;
...
CORE_API PFNGLDELETEBUFFERSPROC 	        glDeleteBuffers;
...
CORE_API PFNGLUNIFORM2FPROC                 glUniform2f;
CORE_API PFNGLUNIFORM1IPROC                 glUniform1i;
