...
void init_scancode_to_key_map( void )
{
    ...
    scancode_to_key_map[ SCANCODE_EQUAL ]              = KEY_EQUALS;
    ...
    scancode_to_key_map[ SCANCODE_LEFT_BRACKET ]         = KEY_BRACKETLEFT;
    scancode_to_key_map[ SCANCODE_RIGHT_BRACKET ]        = KEY_BRACKETRIGHT;
    scancode_to_key_map[ SCANCODE_ENTER ]               = KEY_ENTER;
    scancode_to_key_map[ SCANCODE_LEFT_CONTROL ]         = KEY_CONTROLLEFT;
    ...
    scancode_to_key_map[ SCANCODE_GRAVE_ACCENT ]              = KEY_GRAVE;
    scancode_to_key_map[ SCANCODE_LEFT_SHIFT ]          = KEY_SHIFTLEFT;
    ...
    scancode_to_key_map[ SCANCODE_RIGHT_SHIFT ]         = KEY_SHIFTRIGHT;
    //scancode_to_key_map[ SCANCODE_NUMPAD_MULTIPLY ]    = KEY_NUMPAD_MULTIPLY;
    scancode_to_key_map[ SCANCODE_LEFT_ALT ]            = KEY_ALTLEFT;
    scancode_to_key_map[ SCANCODE_SPACE ]              = KEY_SPACE;
    scancode_to_key_map[ SCANCODE_CAPS_LOCK ]           = KEY_CAPSLOCK;
    ...
    scancode_to_key_map[ SCANCODE_NUM_LOCK ]            = KEY_NUMLOCK;
    scancode_to_key_map[ SCANCODE_SCROLL_LOCK ]         = KEY_SCROLLLOCK;
