...
IF "%1" == "core" (
    ...
    cl %DebugCompilerFlags% /I ..\src\libs\free_type\include\ -Zi /EHsc /FeCore /DCORE_EXPORT /D_CRT_SECURE_NO_WARNINGS /LD ..\src\core\core.cpp user32.lib gdi32.lib opengl32.lib winmm.lib ..\src\libs\free_type\freetype.lib /link /LIBPATH:..\src\libs\free_type\
    cl %DebugCompilerFlags% /I ..\src\libs\free_type\include\ -Zi /EHsc ..\src\engine\launcher.cpp user32.lib gdi32.lib opengl32.lib Core.lib winmm.lib ..\src\libs\free_type\freetype.lib /link /LIBPATH:..\src\libs\free_type\
) ELSE (
